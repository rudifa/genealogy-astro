export const de = {
    ...
    manageTreesTooltip: "Familienbäume erstellen, wechseln, löschen oder zusammenführen",
    ...
    errorSaving: "Ein Fehler beim Speichern ist aufgetreten. Bitte versuchen Sie es erneut.",
    errorRemoving: "Ein Fehler beim Entfernen der Person ist aufgetreten. Bitte versuchen Sie es erneut.",
    ...
    // Confirmations
    confirmRemove: "Sind Sie sicher, dass Sie {name} entfernen möchten? Diese Aktion kann nicht rückgängig gemacht werden.",
    confirmClear: "Sind Sie sicher, dass Sie alle {count} {people} aus der Genealogie entfernen möchten? Diese Aktion kann nicht rückgängig gemacht werden.",
    confirmFamilyExample: "Sind Sie sicher, dass Sie das Familienbeispiel laden möchten? Dies ersetzt Ihre aktuellen Daten und kann nicht rückgängig gemacht werden.",
    confirmResetFamilyExample: "Sind Sie sicher, dass Sie den Familienbeispiel-Baum auf seinen ursprünglichen Zustand zurücksetzen möchten? Dies ersetzt alle aktuellen Daten.",
    confirmLoadFamilyExample: 'Sind Sie sicher, dass Sie die Familienbeispiel-Daten in den "{treeName}"-Baum laden möchten? Dies ersetzt alle aktuellen Daten.',
    resetFamilyExample: "Familienbeispiel Zurücksetzen",
    failedToResetFamilyExample: "Fehler beim Zurücksetzen des Familienbeispiel-Baums",
    errorResetFamilyExample: "Fehler beim Zurücksetzen des Familienbeispiel-Baums: {error}",
    ...
    createNewTreeMerging: "Neuen Baum Erstellen durch Zusammenführung von {treeA} und {treeB}",
    ...
    confirmDeleteTree: 'Sind Sie sicher, dass Sie den Baum "{name}" löschen möchten? Diese Aktion kann nicht rückgängig gemacht werden.',
    ...
    cannotDeleteFamilyExample: "Der Familienbeispiel-Baum kann nicht gelöscht werden",
    cannotRenameFamilyExample: "Der Familienbeispiel-Baum kann nicht umbenannt werden",
    ...
    errorUpdateAfterTreeChange: "Fehler beim Aktualisieren des Graphen nach Baumwechsel",
