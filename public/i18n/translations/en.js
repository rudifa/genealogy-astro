export const en = {
    ...
    pageDescription: "Interactive family tree visualization and genealogy management application.",
    // Header
    appTitle: "Family Tree Explorer",
    appSubtitle: "Visualize and manage your family genealogy with an interactive graph. Click on any person to edit their details or add new family members.",
    // Toolbar
    ...
    errorRemoving: "An error occurred while removing the person. Please try again.",
    ...
    // Confirmations
    confirmRemove: "Are you sure you want to remove {name}? This action cannot be undone.",
    confirmClear: "Are you sure you want to remove all {count} {people} from the genealogy? This action cannot be undone.",
    confirmFamilyExample: "Are you sure you want to load the family example? This will replace your current data and cannot be undone.",
    confirmResetFamilyExample: "Are you sure you want to reset the Family Example tree to its original state? This will replace all current data.",
    confirmLoadFamilyExample: 'Are you sure you want to load the family example data into the "{treeName}" tree? This will replace all current data.',
    ...
    confirmDeleteTree: 'Are you sure you want to delete the tree "{name}"? This action cannot be undone.',
